...
void main (void){
	...
	/* put your password hash here in p[]
	   ...
	   Example: 
	     67a5448ea85a3dd8d8d1e367e1d17646
	     p[]={0x67,0xa5,0x44,0x8e,0xa8,0x5a,0x3d,0xd8}
	     p1[]={0xd8,0xd1,0xe3,0x67,0xe1,0xd1,0x76,0x46};
	 */

	char p[]={0x67,0xa5,0x44,0x8e,0xa8,0x5a,0x3d,0xd8};
	char p1[]={0xd8,0xd1,0xe3,0x67,0xe1,0xd1,0x76,0x46};

	printf("%8s",vncDecryptPasswd(p));
	printf("%s\n",vncDecryptPasswd(p1));
